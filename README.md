<!--
  ...
  A holographic-glass HUD. Every visual below is a self-contained animated SVG
  (pure SVG/SMIL, no JavaScript, no third-party stat services). The files are
  generated by scripts/ and the contribution matrix refreshes daily via Actions.
  Theme-aware: dark-mode = aurora indigo glass, light-mode = a clean daylight HUD.
